...
export type IconName =
  | 'grid' | 'ticket' | 'users' | 'monitor' | 'tag' | 'sparkles' | 'bar-chart'
  | 'settings' | 'bell' | 'user' | 'search' | 'lock' | 'shield' | 'zap'
  | 'arrow-right' | 'chevron-right' | 'chevron-left' | 'eye' | 'eye-off'
  | 'thumbs-up' | 'thumbs-down' | 'plus' | 'check' | 'activity' | 'arrow-up-right'
  | 'x' | 'log-out' | 'download' | 'refresh-cw' | 'filter' | 'list' | 'grid-2'
  | 'paperclip' | 'send' | 'clock' | 'trending-up' | 'alert-triangle' | 'layers'
  | 'map-pin' | 'edit' | 'trash' | 'check-circle' | 'chevron-down' | 'cpu'
  | 'mail' | 'shuffle' | 'lightbulb' | 'phone' | 'menu' | 'linkedin' | 'route';
...
const PATHS: Record<IconName, string> = {
  ...
  tag: '<path d="M20.59 13.41 11 3.83A2 2 0 0 0 9.59 3.2L4 3a1 1 0 0 0-1 1l.2 5.59a2 2 0 0 0 .58 1.41l9.6 9.6a2 2 0 0 0 2.82 0l4.4-4.4a2 2 0 0 0 0-2.79z"/><circle cx="7.5" cy="7.5" r="1.2"/>',
  sparkles: '<path d="M12 2l1.9 5.8L20 9.5l-6.1 1.7L12 17l-1.9-5.8L4 9.5l6.1-1.7L12 2z"/>',
  ...
  'eye-off': '<path d="M17.94 17.94A10.94 10.94 0 0 1 12 20c-7 0-11-8-11-8a21.6 21.6 0 0 1 5.06-6.06M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a21.6 21.6 0 0 1-2.16 3.19m-6.72-1.07a3 3 0 1 1-4.24-4.24"/><path d="M1 1l22 22"/>',
  'thumbs-up': '<path d="M7 10v12"/><path d="M15 5.88 14 10h5.83a2 2 0 0 1 1.92 2.56l-2.33 8A2 2 0 0 1 17.5 22H7a2 2 0 0 1-2-2v-8a2 2 0 0 1 2-2h1.76a2 2 0 0 0 1.79-1.11L14 2a2.5 2.5 0 0 1 1 3.88z"/>',
  'thumbs-down': '<path d="M17 14V2"/><path d="M9 18.12 10 14H4.17a2 2 0 0 1-1.92-2.56l2.33-8A2 2 0 0 1 6.5 2H17a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2h-1.76a2 2 0 0 0-1.79 1.11L10 22a2.5 2.5 0 0 1-1-3.88z"/>',
