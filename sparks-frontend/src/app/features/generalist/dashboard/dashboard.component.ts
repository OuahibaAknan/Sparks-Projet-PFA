...
@Component({
  selector: 'sp-generalist-dashboard',
  standalone: true,
  imports: [CommonModule, KpiStatComponent, AllTicketsTableComponent],
  templateUrl: './dashboard.component.html',
  styleUrl: './dashboard.component.scss',
})
export class GeneralistDashboardComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.ticketService.getPool('generalist').subscribe((tickets) => this.pool.set(tickets));
